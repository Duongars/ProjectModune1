...
function creatDataBase() {
    let dataBase = []
    let item1 = new ProductItems("SB Dunk Low Pro", "image001", 1000000, "Nike", "Việt Nam"); dataBase.push(item1);
    let item2 = new ProductItems("Air Force one", "image002", 1200000, "Nike", "Idonesia"); dataBase.push(item2);
    let item3 = new ProductItems("React Vision", "image003", 1400000, "Adidas", "Thai land"); dataBase.push(item3);
    let item4 = new ProductItems("Dunk Low", "image004", 1700000, "Nike", "Việt Nam"); dataBase.push(item4);
    let item5 = new ProductItems("Air Jordan 1 low", "image005", 1020000, "Nike", "China"); dataBase.push(item5);
    let item6 = new ProductItems("Max Aura 4", "image006", 3200000, "Adidas", "Việt Nam"); dataBase.push(item6);
    let item7 = new ProductItems("Air Monarch 4", "image007", 1200000, "Nike", "China"); dataBase.push(item7);
    let item8 = new ProductItems("Air Max Scorpion Flyknit ", "image008", 2000000, "Nike", "Việt Nam"); dataBase.push(item8);
    let item9 = new ProductItems("Air Max 97 ", "image009", 2100000, "Nike", "Việt Nam"); dataBase.push(item9);
    let item10 = new ProductItems("Court Vision Low Next Nature", "image010", 2020000, "New Balance", "Thai Land"); dataBase.push(item10);
    let item11 = new ProductItems("Jordan Strong Pro", "image011", 3000000, "Nike", "Việt Nam"); dataBase.push(item11);
    let item12 = new ProductItems("Air Jordan 3 Retro", "image012", 3100000, "Nike", "Việt Nam"); dataBase.push(item12);
    let item13 = new ProductItems("Air Max Plus Utility", "image013", 1100000, "Nike", "Indonesia"); dataBase.push(item13);
    let item14 = new ProductItems("Air Max Terrascape 90", "image014", 1200000, "Nike", "Việt Nam"); dataBase.push(item14);
    let item15 = new ProductItems("Jumpman MVP", "image015", 1000000, "Nike", "Việt Nam"); dataBase.push(item15);
    let item16 = new ProductItems("Air Max Plus ", "image015", 1000000, "Nike", "Malaysia"); dataBase.push(item16);
    let item17 = new ProductItems("Waffle DebutNike Waffle Debu ", "image017", 1000000, "Adidas", "Việt Nam"); dataBase.push(item17);
    let item18 = new ProductItems("Air Huarache", "image018", 1020000, "Nike", "China"); dataBase.push(item18);
    let item19 = new ProductItems("Luka 2", "image019", 1350000, "Adidas", "China"); dataBase.push(item19);
    let item20 = new ProductItems("Air Jordan 5 x DJ Khaled", "image020", 1430000, "Nike", "China"); dataBase.push(item20);
    let item21 = new ProductItems("Mecurial Vapor 15 Academy", "image021", 2100000, "Nike", "Việt Nam"); dataBase.push(item21);
            ...
            <div class="grid__column-2-4" >
                ...
                <div class="home-product-item">
                    <div class="home-product-item__img" 
                        style="background-image: url(./database-image/${itemList[index].image}.jpg);"></div>
    ...
    for (var key in listCart) {
        if (listCart[key]) {
         ...
         <img class="header__cart-img"
             src="./database-image/${listCart[key].image}.jpg"
             alt="ảnh sản phẩm">
